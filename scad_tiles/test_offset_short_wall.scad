...
difference()
{
    ...
    translate([tilex*inch/2+inch/2,tiley*inch/2+inch/2,thickness/2])cube([tilex*inch,tiley*inch,thickness],center=true);
    ...
    translate([tilex*inch+inch/2,tiley*inch/2+inch/2,0])rotate([0,30,0])cube([groove,tiley*inch*2,groove*2],center=true);
    translate([0+inch/2,tiley*inch/2+inch/2,0])rotate([0,60,0])cube([groove*2,tiley*inch*2,groove],center=true);
    translate([tilex*inch/2+inch/2,tiley*inch+inch/2,0])rotate([60,0,0])cube([tilex*inch*2,groove*2,groove],center=true);
    translate([tilex*inch/2+inch/2,0+inch/2,0])rotate([30,0,0])cube([tilex*inch*2,groove,groove*2],center=true);
}
//wall
difference()
{
    translate([inch/2+inch/4,tiley*inch/2+inch/2,thickness])cube([inch/2,tiley*inch,thickness*2],center=true);
    //pocks=floor(rands(0,(tilex)*.75,1)[0]);
    pocks=0;
    echo (pocks);
    for (ii=[0:pocks])
    {
        shapenum = floor(rands(0,16,1)[0])+1;
        angle=floor(rands(0,360,1)[0])+1;
        xx=(thickness+.5*inch)*(rands(0,1,1)[0])+inch/2;
        yy=inch*(rands(0,tiley,1)[0]);
        zz=inch-xx;
        %translate([xx,yy,thickness*2])rotate([0,0,angle])blemish(shapenum);
        %translate([inch,yy,thickness*2+zz])rotate([0,90,0])rotate([0,0,angle])blemish(shapenum);
